...
const projects = [
  {
    title: "DevLinkUp",
    description: "A developer matchmaking platform, that helps devs connect, collaborate, and build projects together.",
    image: "/devLinkUp.jpg",
  ...
  },
  {
    ...
    description: "A web application designed to help students track their academic performance and manage their grades effectively.",
