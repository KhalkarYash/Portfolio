...
export default function Contact() {
  ...
  const handleSubmit = (e) => {
    ...
    // Create the mailto link with pre-filled details
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div>
            <motion.input
              ...
              className="w-full px-4 py-3 rounded-lg bg-[#1a1a1a] border border-gray-700 
        ...
        >
          ...
          <div className="flex justify-center space-x-6">
            ...
            <motion.a
              whileHover={{ y: -2 }}
              href="https://x.com/YashKhalkar001"
              target="_blank"
              rel="noopener noreferrer"
              className="text-gray-400 hover:text-white transition-colors"
            >
            ...
            <motion.a
              whileHover={{ y: -2 }}
              href="https://instagram.com/yashkhalkar001"
              target="_blank"
              rel="noopener noreferrer"
              className="text-gray-400 hover:text-white transition-colors"
            >
