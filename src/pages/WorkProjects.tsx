...
import { fetchWorkProjects } from "@/utils/api";
...
const WorkProjects = () => {
  ...
  useEffect(() => {
    fetchWorkProjects()
      .then(setWorkProjects)
      .catch((error) => console.error("Error fetching work projects:", error))
      ...
      <main className="relative max-w-2xl mx-auto px-6 pt-24 pb-32">
        ...
        >
          ...
          <p className="text-muted-foreground text-sm">
            Professional projects I've worked on during internships and
            collaborations.
          </p>
        </motion.div>
